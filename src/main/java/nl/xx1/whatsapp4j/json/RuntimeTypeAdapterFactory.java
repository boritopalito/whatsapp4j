...
public final class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory {
    ...
    /**
     * Creates a new runtime type adapter for {@code baseType} using {@code typeFieldName} as the type field name. Type
    ...
    /** Ensures that this factory will handle not just the given {@code baseType}, but any subtype of that type. */
